...
public class JobEntity {
	...
	public static final String namespace = "quartz_c1_job_detail";
	...
	public JobEntity(String jobName,String jobDescript, String cron,String status) {
		//默认 加载 com.kongtrolink.scloud.job 包下的 类 
		this(jobName,jobDescript,"com.kongtrolink.interweb.job."+jobName,cron,status);
	}
	
	public JobEntity(String jobName,String jobDescript,String jobClass, String cron,String status) {
